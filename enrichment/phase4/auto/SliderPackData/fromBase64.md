...
> [!Warning:$WARNING_TO_BE_REPLACED$] An empty string is silently ignored - the data remains unchanged with no error. Validate input strings before calling if you need to distinguish between "no data" and "restored data".
