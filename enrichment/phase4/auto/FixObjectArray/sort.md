...
> **Warning:** Calling `sort()` without setting a compare function first produces meaningless ordering with no error or warning. The default comparator orders by raw memory layout, not by any property value.
