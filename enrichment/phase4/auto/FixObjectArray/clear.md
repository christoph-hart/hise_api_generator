...
> [!Warning:$WARNING_TO_BE_REPLACED$] Unlike `FixObjectStack.clear()`, this does not change the iteration range. All `length` elements are still visited by for-in loops after clearing - they are simply reset to defaults.
