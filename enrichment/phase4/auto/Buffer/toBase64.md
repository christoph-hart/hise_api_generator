...
> [!Warning:$WARNING_TO_BE_REPLACED$] `fromBase64()` rejects payloads larger than 44100 samples, so very large serialised buffers cannot be restored through that path.
