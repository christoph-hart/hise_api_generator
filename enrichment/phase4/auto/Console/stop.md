...
> [!Warning:$WARNING_TO_BE_REPLACED$] Cannot be used on the message thread - doing so throws a script error. Only use from scripting, audio, or sample-loading threads.
