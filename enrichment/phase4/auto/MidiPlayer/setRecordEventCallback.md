...
> **Warning:** This callback runs on the audio thread and must be an inline function. Regular functions will throw a script error. Avoid any operations that allocate memory or block.
