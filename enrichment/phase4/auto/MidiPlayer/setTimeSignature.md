...
> [!Warning:$WARNING_TO_BE_REPLACED$] The `Tempo` property returned by `getTimeSignature()` is read-only. Including it in the object passed to this method has no effect - tempo is always derived from the host or master clock.
