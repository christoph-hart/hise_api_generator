...
> [!Warning:$WARNING_TO_BE_REPLACED$] Loads the entire sample into memory. When processing many samples in a loop, call `Engine.extendTimeOut()` periodically to prevent the script execution timeout from triggering.
