...
> **Warning:** The internal event queue has a limited lifetime and is cleared after each audio render callback. This method does not work with events delayed via `Message.delayEvent()` after the call.
