...
> [!Warning:$WARNING_TO_BE_REPLACED$] The bound callback executes synchronously on the webview's callback thread. Avoid long-running operations inside the callback - defer heavy work to a timer or background task.
