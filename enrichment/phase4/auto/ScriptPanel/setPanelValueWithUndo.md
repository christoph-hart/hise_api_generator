...
> **Warning:** The `oldValue` parameter must match the panel's current value for undo to restore correctly. It is the caller's responsibility to capture and pass the correct current value before the change.
