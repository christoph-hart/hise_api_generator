...
> **Warning:** The path is scaled to fit the area with non-uniform scaling. If the path's aspect ratio does not match the area's, the mask shape will be distorted.
