...
> **Warning:** Requires OpenGL to be enabled. Shader compilation errors are only logged to the console in the HISE IDE - in exported plugins, a failed shader silently renders nothing.
