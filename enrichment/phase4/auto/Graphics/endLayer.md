...
> [!Warning:$WARNING_TO_BE_REPLACED$] Forgetting to call `endLayer()` causes all subsequent draw calls to target the orphaned layer, and its content is silently discarded at the end of the paint callback.
