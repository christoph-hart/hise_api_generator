...
> **Warning:** Does not resolve symlinks or HISE link file redirects. Two File objects pointing to the same physical file via different paths (e.g. one through a symlink) compare as different.
