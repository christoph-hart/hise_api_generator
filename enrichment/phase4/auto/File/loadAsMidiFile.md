...
> **Warning:** Event timestamps are converted using a fixed sample rate of 44100 Hz and tempo of 120 BPM. If playback conditions differ, timestamps may not correspond directly to playback positions.
