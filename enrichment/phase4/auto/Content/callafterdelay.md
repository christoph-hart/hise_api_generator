...
> [!Warning:$WARNING_TO_BE_REPLACED$] The timing is not sample-accurate. Do not use this for musical or DSP-critical scheduling - use a timer object or the transport handler instead.