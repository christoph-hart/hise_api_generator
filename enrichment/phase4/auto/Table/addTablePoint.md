...
> **Warning:** Each call triggers a full lookup table re-render. Calling `addTablePoint()` in a loop is significantly slower than a single `setTablePointsFromArray()` call with the complete point array.
