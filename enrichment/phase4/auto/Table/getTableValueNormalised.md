...
> **Warning:** Always normalise the input to 0.0-1.0 before calling. Raw MIDI values (0-127) exceed the table range, and any input above 1.0 returns the last table value, effectively flattening the response.
