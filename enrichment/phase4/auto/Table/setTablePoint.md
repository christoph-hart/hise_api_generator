...
> [!Warning:$WARNING_TO_BE_REPLACED$] Edge points (first and last) silently ignore the x parameter - only y and curve are applied. No error is thrown when passing a different x value for an edge point.
