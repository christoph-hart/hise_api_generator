...
> **Warning:** In direct mode, the broadcaster must have exactly 3 arguments. Using a different argument count silently creates the target but produces incorrect property values at dispatch time.
