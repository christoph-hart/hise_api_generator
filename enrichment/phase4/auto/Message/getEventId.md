...
> [!Warning:$WARNING_TO_BE_REPLACED$] Event IDs are unsigned 16-bit integers that wrap around at 65536. Do not assume that older notes have lower IDs than newer ones.
