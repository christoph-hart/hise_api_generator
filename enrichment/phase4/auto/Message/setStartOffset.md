...
> **Warning:** Start offset controls where playback begins within the sample. It does not delay when the event is processed - use `Message.delayEvent()` for timing delays.
