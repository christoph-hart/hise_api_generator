...
> **Warning:** Using a regular `function` instead of `inline function` will be flagged as unsafe in the HISE IDE but may silently fail in exported plugins where the safety check is compiled out.
