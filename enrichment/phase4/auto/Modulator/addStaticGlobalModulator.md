...
> **Warning:** Using this with a continuously changing source (LFO, envelope) captures a single snapshot per note - the modulation will not update during the note's lifetime.
