...
> [!Warning:$WARNING_TO_BE_REPLACED$] The returned value lags behind the actual audio-thread output by one buffer. Do not use it for audio-rate logic or pitch calculations.
