...
> [!Warning:$WARNING_TO_BE_REPLACED$] Created modulators persist in the module tree until explicitly removed with `Synth.removeModulator()`. Forgetting to clean up unused modulators causes accumulating CPU overhead.
