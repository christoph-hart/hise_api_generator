...
> [!Warning:$WARNING_TO_BE_REPLACED$] The blend factor is not clamped to 0.0-1.0. Values outside this range produce extrapolated channel values that may wrap due to byte overflow, yielding unexpected colours.
