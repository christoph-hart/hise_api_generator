...
> [!Warning:$WARNING_TO_BE_REPLACED$] Invalid input (wrong type or element count) silently returns `0` (transparent black) with no error message. Always ensure the array has exactly four elements.
