...
> **Warning:** The returned string is a pool reference, not a filesystem path. Use `FileSystem.fromReferenceString()` to convert it to a File object for directory browsing or path operations.
