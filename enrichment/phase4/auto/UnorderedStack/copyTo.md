...
> **Warning:** When copying to an Array in event mode, each event becomes a new independent MessageHolder. Modifying the copies does not affect the stack's contents.
