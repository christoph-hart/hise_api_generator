...
> **Warning:** Silently returns false when the stack reaches its 128-element capacity. No error is reported, so check the return value if you need to detect overflow.
