...
> [!Warning:$WARNING_TO_BE_REPLACED$] Despite the parameter name `filePath`, this method expects a pool reference string in most workflows. Use `Engine.loadAudioFilesIntoPool()` to get valid reference strings for embedded audio files.
