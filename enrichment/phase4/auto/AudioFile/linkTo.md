...
> [!Warning:$WARNING_TO_BE_REPLACED$] The target must be another AudioFile. Passing a different complex data type (Table, SliderPackData) produces a type mismatch error.
