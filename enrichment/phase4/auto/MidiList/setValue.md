...
> [!Warning:$WARNING_TO_BE_REPLACED$] Out-of-range index writes are silently ignored with no error message. If your indices come from user input or calculations, validate them before calling.
