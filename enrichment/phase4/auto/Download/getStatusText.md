...
> **Warning:** `"Completed"` does not imply success - a connection failure also results in `"Completed"` status. Always check `data.success` alongside the status text to determine the outcome.