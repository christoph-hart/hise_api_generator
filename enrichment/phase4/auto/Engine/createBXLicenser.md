...
> [!Warning:$WARNING_TO_BE_REPLACED$] Calling this without the BX SDK enabled throws a runtime script error. There is no way to check at script level whether the SDK is compiled in.