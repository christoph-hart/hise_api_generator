...
> [!Warning:$WARNING_TO_BE_REPLACED$] This method returns cents, not semitones. It is not a true inverse of `Engine.getPitchRatioFromSemitones()`, which expects semitones as input.