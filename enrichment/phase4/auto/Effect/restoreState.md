...
> **Warning:** Connected UI components (knobs, sliders) do not update automatically after a state restore. Call `updateValueFromProcessorConnection()` on each connected component to resync the display.
