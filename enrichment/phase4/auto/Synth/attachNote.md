...
> [!Warning:$WARNING_TO_BE_REPLACED$] Requires `Synth.setFixNoteOnAfterNoteOff(true)` to be called first, typically in `onInit`. Without it, a script error is thrown.
