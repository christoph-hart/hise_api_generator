...
> [!Warning:$WARNING_TO_BE_REPLACED$] Avoid calling this from a control callback that is itself connected to the same macro control, or you will create a recursive loop that freezes the system.
