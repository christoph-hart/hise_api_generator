...
> [!Warning:$WARNING_TO_BE_REPLACED$] Passing a processor ID like `"MyLFO"` instead of the type name `"LFO Modulator"` returns an empty array with no error, making the mistake hard to diagnose.
