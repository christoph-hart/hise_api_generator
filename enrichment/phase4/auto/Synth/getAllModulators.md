...
> [!Warning:$WARNING_TO_BE_REPLACED$] Unlike `getModulator`, this method searches the entire module tree, not just the parent synth's subtree. A pattern like `"LFO*"` returns LFOs from all synths in the project.
