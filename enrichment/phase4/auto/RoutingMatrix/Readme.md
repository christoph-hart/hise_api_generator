...
- **Use getNumSourceChannels not NumInputs**
...
- **Call setNumChannels before multichannel routing**
...
- **Clear matrix before rebuilding routing**
...
- **Check addConnection return value**
