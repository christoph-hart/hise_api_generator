...
> **Warning:** Under the default stereo constraint, adding a third connection automatically removes an existing one. Call `setNumChannels()` first to relax this limit for multichannel routing.
