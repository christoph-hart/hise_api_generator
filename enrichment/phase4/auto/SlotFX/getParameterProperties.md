...
> [!Warning:$WARNING_TO_BE_REPLACED$] Returns `undefined` for a plain SlotFX module, which has no parameters of its own. The parameters belong to the loaded effect, not the slot container.
