...
> [!Warning:$WARNING_TO_BE_REPLACED$] For scriptnode-based slots, this method only returns available networks in the HISE IDE. In exported plugins it silently returns an empty array - use hardcoded network names instead of querying at runtime.
