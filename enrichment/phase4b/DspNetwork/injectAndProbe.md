...
Input object:
  ...
  probeIndex: int -- child-node index to inspect; -1 = container output after the last child
...
Returned object shape:
  ...
  signal.polyphonic: bool -- true when the network was running with a voice index
...
Anti-patterns:
  ...
  - Do NOT target arbitrary node IDs -- parent must resolve to a supported container implementation.
