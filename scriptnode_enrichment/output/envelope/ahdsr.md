...
- This node is a direct equivalent of the [AHDSR]($MODULES.AHDSR$) envelope modulator in the HISE module tree.

**See also:** $SN.envelope.flex_ahdsr$ -- per-segment curve control and trigger/loop modes, $SN.envelope.simple_ar$ -- lighter two-stage envelope, $SN.envelope.voice_manager$ -- voice lifecycle management
