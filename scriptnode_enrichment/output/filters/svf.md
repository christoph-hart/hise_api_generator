...
llmRef: |
  ...
  Parameters:
    ...
    Mode: LP, HP, BP, Notch, Allpass (default LP).
...
groups:
  ...
  - label: Configuration
    params:
      - { name: Mode, desc: "Filter type.", range: "LP / HP / BP / Notch / Allpass", default: "LP" }
...
**See also:** $SN.filters.svf_eq$ -- SVF with gain-dependent EQ modes, $SN.filters.biquad$ -- biquad with more mode variety but less modulation stability
