...
**See also:** $LANG.scriptnode$ -- conceptual guide to scriptnode networks, containers, parameters, modulation, routing, and compilation, $LANG.hsc#dsp$ -- edit scriptnode graphs from the hise-cli `/dsp` mode
