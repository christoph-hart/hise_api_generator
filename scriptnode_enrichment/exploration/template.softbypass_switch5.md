# template.softbypass_switch5 - Composite Exploration (Variant)

**Base variant:** template.softbypass_switch2
**Variant parameter:** N = 5 (number of switch targets)

## Variant-Specific Behaviour

Identical structure to softbypass_switch2 with these differences:

- **Switch parameter range:** 0-4 (step 1)
- **Number of soft_bypass containers:** 5 (sb1-sb5)
- **xfader NumParameters:** 5
- **SwitchTargets:** 5 connections (sb1-sb5 Bypassed)
...
Yes. Generated from the same `softbypass_switch<5>` template. Only N-dependent values differ.
